...
At the firm this was built for: **~70% of clients send statements as PDFs**, and manual conversion was taking **~30 minutes per statement**, at a volume of 50 to 100 statements a month.
...
| Metric | Value |
|---|---|
| Time saved | **~50 hours/month** (~11.5 hrs/week, ~2.3 hrs/day) |
